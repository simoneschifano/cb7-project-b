...
const Quiz = ({data}) => {
    ...
    return <div className={styles.Quiz__main}>
        ...
        <div className={styles.Quiz__Container}>
            ...
            {
                randomQuest && <div className={styles.Question__Container} key={randomQuest.id} ref={doneAnswer}>
                ...
                <div className={styles.Answers__Container} >
                    ...
                    {randomQuest && randomQuest.answers.map((answer, index) => {
                        return <p key={index} onClick={answer.isCorrect === true ? () => rightAnswer(randomQuest.difficulty) : wrongAnswer} className={styles.Single__Answer}>{answer.answer}</p>
                    })}
